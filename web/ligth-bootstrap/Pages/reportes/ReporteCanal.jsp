...
<html>
    <head>
        ...
        <title>Reporte Sector - SaleslandColombia</title>
    </head>
    <body>
        <div class="wrapper">
                    ...
                    <div class="container-fluid">
                        <div class="row"> 
                            <div class="col-md-10 mr-auto ml-auto">
                                <div class="card">
                                    <form class="form-horizontal" action="PdfCanal.jsp" target="_blank" method="POST" novalidate="novalidate" id="FrmReporteUsuarios" name="FrmReporteUsuarios">
                                        <div class="card-header">
                                            <h4 class="card-title">Reporte Canal</h4>
                                            ...
                                            <div class="card-body col-md-10 mr-auto ml-auto">
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <select id="cmbCanal" name="txtsector" class="form-control">
        ...
        <script>
            ...
            $(document).ready(function (){
                ...
                $("#reporteCanales").addClass('active');
