...
<html>
    <head>
        ...
        <title>Reporte Area - SaleslandColombia</title>
    </head>
    <body>
        <div class="wrapper">
                    ...
                    <div class="container-fluid">
                        <div class="row">   
                            <div class="col-md-10 mr-auto ml-auto">
                                <div class="card">
                                   <form class="form-horizontal" action="PdfArea.jsp" target="_blank" method="POST" novalidate="novalidate" id="FrmReporteUsuarios" name="FrmReporteUsuarios">
                                        <div class="card-header">
                                            <h4 class="card-title">Reporte Areas</h4>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <label class="control-label">Area</label>                                                        
                                                             <select name="txtsector" id="cmbArea" class="form-control">                                                           
                                                        </select>                                                            
                                                    </div>
                                                </div>
                                                 <div class="form-group">
